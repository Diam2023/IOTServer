...
class Topics
{
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Topics, true, true>;
    friend drogon::orm::BaseBuilder<Topics, true, false>;
    friend drogon::orm::BaseBuilder<Topics, false, true>;
    friend drogon::orm::BaseBuilder<Topics, false, false>;
#ifdef __cpp_impl_coroutine
