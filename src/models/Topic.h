...
class Topic
{
  public:
     ...
     */
    explicit Topic(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Topic(const Json::Value &pJson) noexcept(false);
     ...
     */
    Topic(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Topic, true, false>;
    friend drogon::orm::BaseBuilder<Topic, false, true>;
    friend drogon::orm::BaseBuilder<Topic, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Topic>;
#endif
