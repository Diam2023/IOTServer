...
class Users
{
  public:
    struct Cols
    {
        ...
        static const std::string _user_permission_id;
    };
    ...
    /**  For column user_permission_id  */
    ///Get the value of the column user_permission_id, returns the default value if the column is null
    const uint32_t &getValueOfUserPermissionId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getUserPermissionId() const noexcept;
    ///Set the value of the column user_permission_id
    void setUserPermissionId(const uint32_t &pUserPermissionId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint32_t> userPermissionId_;
    struct MetaData
    {
