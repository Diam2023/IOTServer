...
class SubscribeMap
{
  public:
     ...
     */
    explicit SubscribeMap(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit SubscribeMap(const Json::Value &pJson) noexcept(false);
     ...
     */
    SubscribeMap(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    SubscribeMap() = default;
    ...
    const uint32_t &getValueOfMapId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getMapId() const noexcept;
    ///Set the value of the column map_id
    void setMapId(const uint32_t &pMapId) noexcept;
    ...
    void getTopic(const drogon::orm::DbClientPtr &clientPtr,
                  ...
                  const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<SubscribeMap>;
    friend drogon::orm::BaseBuilder<SubscribeMap, true, true>;
    friend drogon::orm::BaseBuilder<SubscribeMap, true, false>;
    friend drogon::orm::BaseBuilder<SubscribeMap, false, true>;
    friend drogon::orm::BaseBuilder<SubscribeMap, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<SubscribeMap>;
#endif
    ...
    std::shared_ptr<uint32_t> mapId_;
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where map_id = ?";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where map_id = ?";
        return sql;
    }
